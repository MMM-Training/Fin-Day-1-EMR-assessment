...
export const SANDBOX_TASKS = [
    {
        title: "Module 1: Appointment Scheduling",
        steps: [
            "**Search Patient:** Locate an existing patient using the top banner search tool.",
            "**Book Appointment:** Click on an empty time slot to open the booking modal.",
            "**Assign Provider:** Schedule an appointment specifically for 'Dr. Smith'.",
            "**Confirm Status:** Set an appointment status to 'FIRM'.",
            "**Block Provider:** Block a specific provider's availability on the schedule.",
            "**Reschedule:** Reschedule an appointment using **Edit/Reschedule** or by **dragging and dropping** it to a different slot.",
            "**Pinboard:** Move an appointment to the Pinboard for rescheduling."
        ]
    },
    {
        title: "Module 2: Family File",
        steps: [
            "**New Patient:** Create a brand new patient profile from scratch.",
            "**Add Member:** Add a family member to an existing patient's household.",
            "**Demographics:** Update a patient's address or primary contact information.",
            "**Medical Alert:** Add a specific Medical Alert (e.g., 'Penicillin Allergy').",
            "**Status Update:** Change a patient's account status to 'Inactive'.",
            "**Automation:** Manually toggle a reminder status in Automated Communications.",
            "**Photo:** Upload a simulated photo to a patient's record."
        ]
    },
    {
        title: "Module 3: Ledger",
        steps: [
            "**View Ledger:** Open a patient's ledger to review historical transactions.",
            "**Post Payment:** Post a patient payment of exactly $100.",
            "**New Charge:** Manually post a procedure charge to the ledger.",
            "**Adjustment:** Apply a write-off or adjustment to an account balance.",
            "**Claim:** Generate and send an insurance claim from the ledger.",
            "**Pre-Auth:** Submit a pre-authorization for a planned procedure.",
            "**Refund:** Process a simulated patient refund transaction."
        ]
    },
    {
        title: "Module 4: Office Manager",
        steps: [
            "**Day Sheet:** Run the 'Day Sheet' report for the current reference date.",
            "**Update Date:** Change the reference date to a past date in the sidebar.",
            "**Deposit Slip:** Access and review the bank 'Deposit Slip' registry.",
            "**Recall Hub:** Navigate to the 'Recall Management' center.",
            "**Recall Config:** Create or update a clinical 'Recall Type' configuration.",
            "**Export Data:** Export any office report or ledger view to a CSV or PDF file.",
            "**End of Day:** Execute the 'End-of-Day' sequence in the Office Manager."
        ]
    },
    {
        title: "Module 5: Chart",
        steps: [
            "**Tooth Search:** Use the 'TOOTH #' input to focus a specific tooth.",
            "**Missing:** Update a tooth's clinical status to 'Missing'.",
            "**TX Plan:** Set a tooth status to 'Treatment Planned'.",
            "**Procedure:** Assign a specific ADA code procedure to a tooth.",
            "**Save Note:** Save a clinical progress note to the chart history.",
            "**Bulk Update:** Use multi-select to update the status of several teeth at once.",
            "**History Log:** Review the 'Clinical History' table for a selected patient."
        ]
    }
];
